        ...
        <>
            ...
            <div className="mywinning-container">
                <div className="mywinning-container-card">
                    ...
                    {products.filter(product => product.status === 'paid').map((product) => {
                        ...
                        return (
                            <div className="mywinning-card" key={product.id}> 
                                <div className='mywinning-card-absolute'>
                                    <span className={`mywinning-card-status-${statusClass}`}>{product.status}</span>
                                </div>
                                <img 
